...
All OPTIONS are passed to Net::FTP method C<new()>.  These options
...
How many different connections will we use. Between each attempt,
...
This module is part of Net-FTP-Robust distribution version 0.02,
built on July 16, 2009. Website: F<http://perl.overmeer.net>
